...
interface MunicipeDetailsDialogProps {
  ...
  onEdit?: (municipe: any) => void;
}

export function MunicipeDetailsDialog({ municipe, open, onOpenChange, onEdit }: MunicipeDetailsDialogProps) {
                  ...
                  {onEdit && (
                    <div className="flex items-center gap-2 ml-4">
                      <Button
                        ...
                        onClick={() => {
                          onOpenChange(false);
                          setTimeout(() => onEdit(municipe), 100);
                        }}
                      >
                ...
                <div className="border-t pt-4">
                  <div className="flex flex-wrap gap-6 text-xs text-muted-foreground">
                    <div className="flex items-center gap-1">
                      ...
                      <span>Cadastrado em: {municipe.created_at ? formatDateTime(municipe.created_at) : 'Não informado'}</span>
                    </div>
