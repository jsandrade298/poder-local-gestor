...
// ============================================
// COMPONENTE DE CONTROLE DE ROTAÇÃO
// ============================================
...
interface ClusterMapProps {
  ...
  // Callback para mudança de rotação (opcional)
...
export function ClusterMap({
  ...
  return (
    ...
    >
      ...
      {/* Controle de Rotação com Bússola */}
      <RotationControl onBearingChange={onBearingChange} />
