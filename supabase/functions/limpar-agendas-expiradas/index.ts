...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`✅ ${agendasExpiradas.length} agendas confirmadas expiradas foram excluídas com sucesso`);

    return new Response(
      JSON.stringify({ 
        success: true, 
        message: `${agendasExpiradas.length} agendas confirmadas expiradas foram excluídas`,
