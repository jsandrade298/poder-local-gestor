...
-- Configurar a chave anônima do sistema
ALTER DATABASE postgres SET "app.anon_key" = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5zb2VkemVmcnFqbWJnYWh1a3ViIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTY5MTQ1NjgsImV4cCI6MjA3MjQ5MDU2OH0.ucqQ7-hskVwAd-UkyKk9rB7FCEPPH8hkm7k8evzoU_4';
...
-- Criar função para facilitar testes manuais
CREATE OR REPLACE FUNCTION public.executar_aniversarios_teste()
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
BEGIN
  SELECT net.http_post(
    ...
    body := jsonb_build_object('teste', true)
  ) INTO result;
